...
#define CONFIG_CMD_LINE_ARGS                                                            \
	"mem=128M cma=8M ubi.mtd=rootfs root=ubi0:rootfs rootfstype=ubifs init=/init console=ttyS3,115200 rootwait" \
...
#define CONFIG_SPINAND_DTB_ADDR	   (0x40000) 
#define CONFIG_SPINAND_KERNEL_ADDR (0x80000) 
