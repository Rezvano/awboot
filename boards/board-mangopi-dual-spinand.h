...
#define CONFIG_CMD_LINE_ARGS                                                                                     \
	"mem=128M cma=8M root=/dev/mmcblk0p2 init=/sbin/init console=ttyS3,115200 earlyprintk=sunxi-uart,0x02500c00 " \
	"rootwait"
...
#define CONFIG_SPINAND_DTB_ADDR	   (128 * 2048) //262144
#define CONFIG_SPINAND_KERNEL_ADDR (256 * 2048) //524288
